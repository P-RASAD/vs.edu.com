  ...
  const curatedPaths = [
    {
      ...
      desc: "Complete syllabus for SSC, CBSE & ICSE boards with chapter-wise mock tests and video lectures.",
      time: "120 hours",
      icon: <BookOpen className="w-10 h-10 text-emerald-500" />,
      bgLeft: "from-emerald-600/30",
      architecture:
        "Phase 1: Concept Building → Phase 2: Application & Practice → Phase 3: Mock Board Exams",
      concepts: [
        "Algebra & Geometry",
        "Physics Mechanics",
        "Chemical Reactions",
    ...
    },
    {
      ...
      desc: "Deep dive into MPC, BiPC, and Commerce for board excellence and competitive entrance exams.",
      time: "180 hours",
      icon: <Layers className="w-10 h-10 text-blue-500" />,
      bgLeft: "from-blue-600/30",
      architecture:
        "Phase 1: Core Subjects → Phase 2: Competitive Prep (JEE/NEET) → Phase 3: Revision",
      concepts: [
        "Calculus & Vectors",
        "Organic Chemistry",
        "Human Anatomy",
    ...
    {
      id: "p3",
      title: "Undergrad & Degree",
      desc: "B.Tech, B.Com, and B.Sc semester preparations and core subject mastery for university students.",
      time: "200 hours",
      icon: <GraduationCap className="w-10 h-10 text-purple-500" />,
      bgLeft: "from-purple-600/30",
      architecture:
        "Semester 1-4: Core Theory → Semester 5-6: Advanced Electives → Semester 7-8: Internships",
      concepts: [
        "Data Structures",
    ...
    },
    {
      ...
      desc: "Structured coaching for SSC CGL, Banking, RRB, and state-level public service commissions.",
      time: "150 hours",
      icon: <ShieldCheck className="w-10 h-10 text-rose-500" />,
      bgLeft: "from-rose-600/30",
      architecture:
        "Tier 1: Prelims Mastery → Tier 2: Mains Deep Dive → Tier 3: Interview Prep",
      concepts: [
  ...
  const carouselCards = [
    {
      ...
      desc: "Master the complete Class 10 Mathematics syllabus with step-by-step explanations, 3D visualizations, and board-level mock tests.",
      notes:
        "Includes PDF revision notes, formula cheat sheets, and previous year question paper solutions.",
      curriculum: [
    ...
    },
    {
      ...
      desc: "A deep dive into 11th and 12th-grade Physics. Perfect for board exams and building a foundation for JEE/NEET.",
      notes:
        "Features interactive lab simulations and daily practice problem (DPP) sheets.",
      curriculum: [
    ...
    },
    {
      ...
      video: "https://www.youtube.com/embed/jfKfPfyJRdk",
      desc: "The ultimate guide to Computer Science core subjects. Learn Data Structures, Algorithms, OS, and Database Management Systems.",
      notes:
        "Includes access to a cloud-based coding IDE and interview preparation guide.",
      curriculum: [
    ...
    },
    {
      ...
      video: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      desc: "Comprehensive coaching for the SSC CGL exam. Covers Quantitative Aptitude, Reasoning, English, and General Awareness.",
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold text-lg shadow-lg shadow-blue-600/30 transition-all"
            >
